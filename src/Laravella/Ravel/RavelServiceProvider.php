...
class RavelServiceProvider extends ServiceProvider {
	...
	{
		$path = $this->guessPackagePath();
		$handlerPath = $path . '/Laravella/Ravel/ExceptionHandlers/Exceptions';
		...
		$handlerPath = $path . '/Laravella/Ravel/ExceptionHandlers/ErrorHandlers.php';
	...
	{
		$path = $this->guessPackagePath();
		$handlerPath = $path . '/Laravella/Ravel/Events.php';
